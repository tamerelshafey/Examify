                ...
                <header className="sticky top-0 z-40 w-full backdrop-blur-sm bg-slate-50/70 dark:bg-slate-950/70 border-b border-slate-200 dark:border-slate-800">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center space-x-4">
                             ...
                             <button id="header-login-button" onClick={() => setIsLoginModalOpen(true)} className="hidden md:block bg-primary-500 hover:bg-primary-600 text-white font-semibold py-2 px-4 rounded-lg transition-colors text-sm">
                                {t.login}
                             </button>
                        </div>
                    </div>
